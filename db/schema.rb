...
ActiveRecord::Schema[7.0].define(version: 2023_08_12_014038) do
  ...
  create_table "user_campaign_sessions", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "campaign_session_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["campaign_session_id"], name: "index_user_campaign_sessions_on_campaign_session_id"
    t.index ["user_id"], name: "index_user_campaign_sessions_on_user_id"
  end
  ...
  add_foreign_key "user_campaign_sessions", "campaign_sessions"
  add_foreign_key "user_campaign_sessions", "users"
end
