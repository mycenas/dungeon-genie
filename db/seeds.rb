...
[User, Race, Character, CharacterClass, Stats, CampaignOption, Campaign].each do |model|
  model.destroy_all
end
...
whispers_campaign = CampaignOption.create(name: "Whispers in the Sandsea", location: "The Sandsea Deserts", description: "Journey through the endless Sandsea dunes where voices carried by the wind tell tales of a buried kingdom and forgotten empire. Encounter mystical oases, sandstorms, and riddles hidden beneath the golden grains.", image_url: "whispers_in_the_sandsea.png")
